...
<div class="top"><h1><bean:message key="text.deliveryinfo"/></h1></div>
...
<div class="middle">
	...
	<table style="font-size: 12px;">
		...
		<bean:write name="rekening" property="bank"/>&nbsp;
		Rek.&nbsp;<bean:write name="rekening" property="rekening"/>
		</input></td>
		</tr>
		</logic:iterate>
		<input type="hidden" name="id" value="delivery"/>
	</table>
	</div>	
	<b style="margin-bottom: 3px; display: block;"><bean:message key="text.addcomment"/></b>
    <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 10px;">            
      <textarea rows="3" cols="60" name="comment">${comment}</textarea>
    </div>
    
    </form>
	
	<b style="margin-bottom: 3px; display: block;"><bean:message key="text.newadderess"/><bean:message key="text.newadderess"/></b>
	<div class="buttons">	
	<table style="font-size: 12px;">
		...
		<tr><td></td>
		<td align="right">
		<html:link href="#" onclick="addAddress.submit()" styleClass="button">
		<span><bean:message key="text.addadderess"/></span>
		</html:link>
